...
export default function PendingApprovalsPage() {
  ...
  const fetchSubmissions = useCallback(async () => {
    ...
    try {
      const response = await fetch('https://harisindustries.com.ng/busa-api/database/get_product_stock_logs.php?type=PENDING_APPROVAL');
  ...
  const handleApprovalAction = async (logEntry: ProductStockAdjustmentLog, action: 'accept' | 'reject') => {
    ...
    try {
      const endpoint = action === 'accept'
        ? 'https://harisindustries.com.ng/busa-api/database/approve_stock_submission.php'
        : 'https://harisindustries.com.ng/busa-api/database/delete_product_stock_log.php';
