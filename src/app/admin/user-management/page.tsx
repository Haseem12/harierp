...
export default function UserManagementPage() {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch('https://sajfoods.net/busa-api/database/get_users.php')
      .then(res => res.json())
      .then(data => {
        if (data.success) {
          setUsers(data.data);
  ...
  const handleSaveChanges = async () => {
    ...
    try {
        const response = await fetch('https://sajfoods.net/busa-api/database/save_user_settings.php', {
            method: 'POST',
  ...
  const handleResetPassword = async (userId: string, userName: string) => {
    try {
        const response = await fetch('https://sajfoods.net/busa-api/database/reset_user_password.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
