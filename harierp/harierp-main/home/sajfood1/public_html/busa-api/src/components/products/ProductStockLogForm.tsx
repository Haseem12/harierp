...
export default function ProductStockLogForm({ 
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isEditMode && existingLogEntry) {
      ...
      try {
        const response = await fetch('https://harisindustries.com.ng/busa-api/database/update_product_stock_log.php', {
      ...
      try {
        const response = await fetch('https://harisindustries.com.ng/busa-api/database/save_product_stock_log_batch.php', {
