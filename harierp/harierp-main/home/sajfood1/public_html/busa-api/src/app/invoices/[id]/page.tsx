...
export default function InvoiceDetailsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      // Fetch Invoice
      const invoiceRes = await fetch(`https://harisindustries.com.ng/busa-api/database/get_invoice.php?id=${invoiceId}`);
      ...
      if (invoiceData.success && invoiceData.data) {
        ...
        if (fetchedInvoice.customer?.id) {
          const receiptsRes = await fetch(`https://harisindustries.com.ng/busa-api/database/get_receipts.php?customerId=${fetchedInvoice.customer.id}`);
  ...
  const handleDeleteInvoice = async () => {
    if (!invoice) return;
    try {
      const response = await fetch("https://harisindustries.com.ng/busa-api/database/delete_invoice.php", {
        method: "POST",
