...
try {
    ...
    // --- Fetch Purchase Items with Supplier Name ---
    ...
    $sql = "SELECT 
            ...
            LEFT JOIN ledger_accounts la ON pi.supplierId = la.id -- LEFT JOIN to include items without a supplier
