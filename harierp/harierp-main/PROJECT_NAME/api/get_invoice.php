...
$invoice_id = isset($_GET['id']) ? $_GET['id'] : null; // Changed variable name for clarity
...
try {
    ...
    $stmt_items->bind_param("s", $invoice_id); // Corrected variable name from $invoiceId to $invoice_id
    $stmt_items->execute();
